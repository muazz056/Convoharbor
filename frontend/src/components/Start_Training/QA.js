           ...
           <div className="d-flex">
            ...
            {/* CHAT WINDOW */}
                <div className="chat-window">
                  <button className="btn gradient-btn"><i class="fas fa-plus"></i> Add new Questions and Answers</button>
                   <div className='mt-2'>
                   <div className='bg-dark text-light p-3 rounded'>Q/A Sources</div>
