        ...
        <InnerNavbar />
           <div className="d-flex">
              ...
              <div className="sidebar d-flex flex-column align-items-start p-3 bg-light">
                ...
                {/* GPT MINI */}
                <Link to="/chatbot/training/question_answer" className="sidebar-button-selected mb-2 w-100 text-start"><i class="fas fa-circle-question me-2"></i>Question & Answer</Link>
          
                {/* Start Training with Brain Icon */}
                <Link to="/chatbot/training/text" className="sidebar-button-selected mb-2 w-100 text-start d-flex align-items-center">
            ...
            {/* CHAT WINDOW */}
                <div className="chat-window">
                  <button className="btn gradient-btn"><i class="fas fa-plus"></i> Add new text files</button>
                   <div className='mt-2'>
                   <div className='bg-dark text-light p-3 rounded'>Text file Sources</div>
