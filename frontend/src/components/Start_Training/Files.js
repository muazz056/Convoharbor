        ...
        <InnerNavbar />
           <div className="d-flex">
              ...
              <div className="sidebar d-flex flex-column align-items-start p-3 bg-light">
                ...
                {/* Copy Text Icon */}
                <Link to="/chatbot/training/files" className="sidebar-button-selected mb-2 w-100 text-start d-flex align-items-center">
            ...
            {/* CHAT WINDOW */}
                <div className="chat-window">
                  <button className="btn gradient-btn"><i class="fas fa-plus"></i> Add new files</button>
                   <div className='mt-2'>
                   <div className='bg-dark text-light p-3 rounded'>File Sources</div>
