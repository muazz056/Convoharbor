        ...
        <InnerNavbar />
           <div className="d-flex">
              ...
              <div className="sidebar d-flex flex-column align-items-start p-3 bg-light">
                ...
                <div className="position-relative w-100 mb-2">
                  <Link to="/chatbot/training/corrections" className="sidebar-button-selected w-100 text-start d-flex align-items-center">
            ...
            {/* CHAT WINDOW */}
                <div className="chat-window">
                  <button className="btn gradient-btn"><i class="fas fa-plus"></i> Add new corrections</button>
                   <div className='mt-2'>
