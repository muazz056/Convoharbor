...
class ConversationService:
    ...
    def __init__(self):
        ...
        self.farewell_patterns = [
            ...
            r'\b(thanks|thank you|thanks a lot|thank you so much|appreciate it|cheers)\b',
            r'\b(that\'s all|that is all|nothing else|no more questions|i\'m done|im done)\b',
            r'\b(end|finish|stop|quit|exit|close|done)\b',
            r'\b(adios|au revoir|auf wiedersehen|arrivederci|sayonara)\b',  # Multi-language farewells
            r'^(bye|thanks|done)[\s\W]*$',  # Simple farewells
        ]
    ...
    def should_show_rating_prompt(self, conversation_id: int) -> bool:
        ...
        try:
            ...
            return (conversation.conversation_ended and 
                    conversation.satisfaction_rating is None)
